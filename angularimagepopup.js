        ...
        .directive('angularImagePopup', ['$window',
            function ($window) {
                ...
                function link (scope, element, attrs) {
                    ...
                    img.setAttribute('style', 'max-width: 98vw; position: fixed; left: 50%; top: 0%; transform: translate(0%, 0%); transition: transform 0.1s ease 100ms, opacity 0.1s ease 100ms; opacity: 0;pointer-events:none; z-index: 1100;');
                    document.body.appendChild(img);

                    $(document).keydown(reset);
                    try {
